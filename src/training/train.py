...
from torch.utils.data import DataLoader  # DataLoader for batching
import matplotlib.pyplot as plt  # plotting

from models.diffusion_model import DiffusionModel  # your diffusion model
...
def train_model(
    ...
    if show_detail:
        ...
        with torch.no_grad():
            ...
            full_sample = model.sample_total(start_full, end_full, shift,min_value = -4 ,max_value =3, device=device)
