...
def train_diffusion_model(
    ...
    if dataset_cls is TrendWindowDataset:
        ...
        # If ResidualWindowDataset has extra params, read them here
        # e.g. epsilon = float(config_section.get('epsilon', 1e-6))
        dataset = dataset_cls(
            series_list=series_list,
            window_size=window_size,
            # epsilon=epsilon
    ...
    print(f"\nStarting {save_prefix.capitalize()} Model Training "
    ...
    print(f"{save_prefix.capitalize()} training complete. "
